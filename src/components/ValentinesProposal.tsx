      ...
      <AnimatePresence mode="wait">
        {step === 0 && (
          <motion.h2
            ...
            exit={{ opacity: 0 }}
          >
            Congratulations! You have completed the game (itna dimaag kaam py hi lga leti).
          </motion.h2>
        )}
        {step === 1 && (
          <motion.h2
        ...
        {step === 2 && (
          ...
          >
            ...
            >
              Meri toh h hi BUT Will you be my Valentine?
            </h2>
            <Image
              src="/sad_hamster.png"
              alt="Sad Hamster"
        ...
        {step === 3 && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            HEHE PHAS GYI NA MERY JAAL MAIN, I love you! 💕
